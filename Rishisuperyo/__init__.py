...
if ENV:
    ...
    TELETHON_ID = int(os.environ.get("TL_APP_ID", "2623905"))
    TELETHON_HASH = os.environ.get("TL_HASH", "f973f59c637be60301b32ae8c44a9e02")
...
from Rishisuperyo.modules.helper_funcs.handlers import CustomCommandHandler  # noqa
