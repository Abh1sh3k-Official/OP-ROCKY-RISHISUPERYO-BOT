...
import Rishisuperyo.modules.sql.welcome_sql as sql
from Rishisuperyo import DEV_USERS, LOGGER, MESSAGE_DUMP, OWNER_ID, dispatcher, spamwtc
from Rishisuperyo.modules.helper_funcs.alternate import send_message, typing_action
from Rishisuperyo.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from Rishisuperyo.modules.helper_funcs.misc import (
    build_keyboard,
    build_keyboard_parser,
    revert_buttons,
)
from Rishisuperyo.modules.helper_funcs.msg_types import get_welcome_type
from Rishisuperyo.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
    markdown_to_html,
)
from Rishisuperyo.modules.log_channel import loggable
from Rishisuperyo.modules.sql.global_bans_sql import is_user_gbanned
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "My Owner iz here 🥳🥳🥳 party over night!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "My Dev Here, Let's See What Will Happene Now.. 🔥",
                    reply_to_message_id=reply,
                )
                continue
