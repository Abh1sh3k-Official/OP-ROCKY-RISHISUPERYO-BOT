...
import Rishisuperyo.modules.sql.notes_sql as sql
from Rishisuperyo import LOGGER, MESSAGE_DUMP, dispatcher
...
from Rishisuperyo.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Rishisuperyo.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Rishisuperyo.modules.helper_funcs.msg_types import get_note_type
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names. Ask to @P_rinc_e if you're unable to figure it out!"
            )
