...
import Rishisuperyo.modules.sql.feds_sql as sql
from Rishisuperyo import (
    DEV_USERS,
    LOGGER,
    MESSAGE_DUMP,
    OWNER_ID,
...
from Rishisuperyo.modules.helper_funcs.alternate import (
    send_action,
    send_message,
    typing_action,
)
from Rishisuperyo.modules.helper_funcs.chat_status import is_user_admin
from Rishisuperyo.modules.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
from Rishisuperyo.modules.helper_funcs.string_handling import markdown_parser

# Hello bot owner, I spended for feds many hours of my life, Please don't remove this if you still respect Rishisuperyo and Rocky  too
    ...
    update.effective_message.reply_text(
        "Are you sure you want to delete your federation? This action cannot be canceled, you will lose your entire ban list, and '{}' will be permanently lost.".format(
            ...
            [
                [
                    InlineKeyboardButton(
                        text="⚠️ Remove Federation 🔥", callback_data="rmfed_{}".format(fed_id), )], [
                            InlineKeyboardButton(
